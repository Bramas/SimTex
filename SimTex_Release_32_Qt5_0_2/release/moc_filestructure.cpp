...
#include "../../SimTex/filestructure.h"
...
struct qt_meta_stringdata_FileStructure_t {
    QByteArrayData data[3];
    char stringdata[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_FileStructure_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_FileStructure_t qt_meta_stringdata_FileStructure = {
    {
QT_MOC_LITERAL(0, 0, 13),
QT_MOC_LITERAL(1, 14, 15),
QT_MOC_LITERAL(2, 30, 0)
    },
    "FileStructure\0updateStructure\0\0"
};
...
const QMetaObject FileStructure::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FileStructure.data,
      qt_meta_data_FileStructure,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileStructure.stringdata))
