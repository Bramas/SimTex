...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Builder_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 73, 10)
    ...
    "Builder\0statusChanged\0\0pdflatex\0"
    "onFinished\0exitCode\0QProcess::ExitStatus\0"
    "exitStatus\0"
};
...
void Builder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Builder::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Builder::statusChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Builder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Builder.data,
      qt_meta_data_Builder,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Builder.stringdata))
