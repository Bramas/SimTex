...
#include "../../SimTex/widgetlinenumber.h"
...
struct qt_meta_stringdata_WidgetLineNumber_t {
    QByteArrayData data[3];
    char stringdata[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_WidgetLineNumber_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_WidgetLineNumber_t qt_meta_stringdata_WidgetLineNumber = {
    {
QT_MOC_LITERAL(0, 0, 16),
QT_MOC_LITERAL(1, 17, 23),
QT_MOC_LITERAL(2, 41, 0)
    },
    "WidgetLineNumber\0updateFirstVisibleBlock\0"
    "\0"
};
...
const QMetaObject WidgetLineNumber::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WidgetLineNumber.data,
      qt_meta_data_WidgetLineNumber,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WidgetLineNumber.stringdata))
