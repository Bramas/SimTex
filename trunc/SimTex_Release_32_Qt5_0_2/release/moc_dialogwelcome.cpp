...
#include "../../SimTex/dialogwelcome.h"
...
struct qt_meta_stringdata_DialogWelcome_t {
    QByteArrayData data[1];
    char stringdata[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_DialogWelcome_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_DialogWelcome_t qt_meta_stringdata_DialogWelcome = {
    {
...
const QMetaObject DialogWelcome::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogWelcome.data,
      qt_meta_data_DialogWelcome,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DialogWelcome.stringdata))
