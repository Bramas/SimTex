...
#include "../../SimTex/widgetscroller.h"
...
struct qt_meta_stringdata_WidgetScroller_t {
    QByteArrayData data[4];
    char stringdata[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_WidgetScroller_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_WidgetScroller_t qt_meta_stringdata_WidgetScroller = {
    {
...
QT_MOC_LITERAL(3, 24, 10)
    ...
    "WidgetScroller\0changed\0\0updateText\0"
};
...
void WidgetScroller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WidgetScroller::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WidgetScroller::changed)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject WidgetScroller::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WidgetScroller.data,
      qt_meta_data_WidgetScroller,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WidgetScroller.stringdata))
